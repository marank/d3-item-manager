...
gulp.task('app:items', require('./gulp/appItems.task'));
gulp.task('app:lang', require('./gulp/appLang.task'));
...
gulp.task('app', gulp.parallel('app:html', 'app:js', 'app:less', 'app:items', 'app:lang', 'app:version', 'app:images'));
